...
propOfDeath <- exp(-2.64 + (0.67 * x_logdose)) / ( 1 + exp(-2.64 + (0.67 * x_logdose)))
#propOfDeath

oddsOfDeath <- propOfDeath / (1 - propOfDeath)
...
```{r q1e-1}
print(paste("Probability of Death: ",propOfDeath))
...
Ey <- exp(linearPart) / (1 + exp(linearPart))
Ey
```
**Answer q2f**: I estimate an 11% probability this patient received a flu shot.
...
**Answer q2g**: I would expect the odds of the similar patient, except 1 year older than 70 to be 11.08 + (11.08 * .076)% ~= 11.9%
