...
Whether the residuals are uncorrelated when the 0 nitrogen values have been excluded must also be investigated. Removing nitrogen = 0 values will change the inquiry to: "When nitrogen has been applied to field, is there a linear relationship between amount of nitrogen added, and yield?"
...
Investigate if the correlation of the residuals has been addressed by removing the x = 0 values.
...
Use the 1/y transformation on the o-filtered data set, and then compare the 1/y residual plots of the original and the filtered data sets.
...
# run the inv y transformation on the cornnitFilteredModel
...
plot(cornnitFilteredModel.invy$fitted.values,cornnitFilteredModel.invy$residuals, main="0-Filtered: 1/y")
abline(h=0,col="red")
