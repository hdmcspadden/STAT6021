...
**Answer**
Yes, I agree, I think the variance looks unstable. Box-Cox is an analytical method to evaluate the constant variance, and normality assumption. If 0 lies within the Box-Cox CI, then we can use a ln transformation.
...
**Answer** This is much better on the mean 0 residuals assumption. I still think the variance around fitted value 3.8 looks a little odd.
