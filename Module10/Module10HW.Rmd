...
Refernce class is **full term pregnancies**. There are 2 logits that are each compared against probability of full term pregnancy.

odds preterm vs full term = exp(5.48 - (0.65 * nutrition) + (2.96 * less20) + (2.06 * greater30) + (2.04 * alcohol) +(2.45 * smoking))

odds intermediate vs full term = exp(3.96 - (0.46 * nutrition) + (2.91 * less20) + (1.89 * greater30) + (1.07 * alcohol) +(2.23 * smoking))
