...
Get the MSE to bestlambda with lasso:
```{r q3-1}
##fit ridge regression using training data
ridge.mod<-glmnet(x[train,],y[train],alpha=1,lambda=bestlamlasso, thresh = 1e-14)

##Test MSE with best lambda
ridge.pred<-predict(ridge.mod,s=bestlamlasso,newx=x[test,])
mean((ridge.pred-y.test)^2)
```

MSE of LASSO: **8.083576**
...
This is the plot of MSE against the estimated coefficients. How is this plot different than the one from ridge regression?
...
plot(out.all, xvar = "lambda", ylim=c(-1,1))
