...
The difference in mean teacher salary rating between the North and South regions is 0.05294. In other words, the mean salary for Northern teachers is $529.40 more than Southern teachers.
...
seB2B3hatv2 <- 588126.72 + 641873.8 - (2 * 244238.0)
...
**Need to rewrite**
When spending per student is held constant, the difference in mean pay for teachers in the North vs. South or West, the CI's are a large range which include 0. 0 being within the range, and the high estimated variance for each coefficient lead me to conclude that when taking spending for student into account salaries for teachers vs. Nothern teachers is not predicted well by the model.



When spending per student is held constant, the difference in mean pay for teachers in the North vs. teachers in the West is standard at ~ -1674.00 dollars and the difference in mean pay for teachers in the South vs teachers in the West is standard at ~ -1144.60 dollars
