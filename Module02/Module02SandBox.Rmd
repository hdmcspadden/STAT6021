...
multiple bith top and bottom by Sxx
...
```{r}
tvalue1 <- abs(qt(0.975, 8)) # tvalue for 95% 2-sided, with n==10
print(tvalue1)

tvalue2 <- abs(qt(0.995, 8)) # tvalue for 99% 2-sided, with n==10
print(tvalue2)
```
...
CI of the mean of y at a particular value of x tells us how well our model performs as x changes. The more stabel the CI as x changes from the mean, the better our model predcts at the extremes of x.
