...
**CI for mean number of broken ampules**
10.2 + 4(2) +- (2.306004)sqrt((2.2)(.1 + ((2 - 1)^2/10))
 
18.2 +- (2.306004) * sqrt((2.2)(.1 + .1))
 
18.2 +- (2.306004) * sqrt(2.2 * .2)
 
18.2 +- (2.306004) * (0.6633)
 
18.2 +- 1.53
 
**95% CI for mean ampules broken when there are 2 transfers is 16.67 - 19.73**

** CI for predicted number of broken ampules when number of transfers is 2**
...
A slope of zero mean that y never changes, no matter the value of x. x could be anything, and y remains stable. Like the speed of light, no matter what the hair color of a person is, the speed of light remains the same. That relationship **should** have a slope of zero.

If the slope is not equal to 0, then the value of y does change, to some degree, as the value of x changes. That change expresses some type of linear relationship.
