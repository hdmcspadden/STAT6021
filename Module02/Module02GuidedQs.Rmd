...
```
** Maybe Answer **
We are 95% confident that repeated samples of 26 weights will produce a model with a B1-hat between 0.4182 and 0.4206

Which means a 95% confidence that the BP will increase between 0.4182 and 0.4206 with each one pound increase.
...
**Hypothesis: ** H0: there is no linear relationship between weight and BP., Ha: There no an absence of linear relationship between weight and BP.
...
In part 3, the CI for 95% CI in slope was very small, which makes me think our model is pretty good, and then the F value and p-value also make me think we have a linear relationship. So, yes, I **think** they are consistent.
...
I feel like question 3b answers this with the 95% confidence interval for B1-hat: 0.4182 and 0.4206

0.35 is outside this range, thus, we can say that males age 25-30 are at increased risk.
...
```
**UMMM, is this right??**
That is HUGE and would indicate that we should ABSOLUTELY reject H0.
