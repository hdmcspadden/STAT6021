...
hatDiagonals <- lm.influence(bestBICModel)$hat
...
About 75%-78% of the variance in y is predicted by the model containing x2, x7, x8: passing yards, percent rushing, and opponents' rushing yards.
...
Only ~54 - 64% of the variance in games won is explained by the model containing x2, x7, x8: passing yards, percent rushing, and opponents' rushing yards. The significance of the model using half the dataset is considerably lower than when using the full data set.
...
**Answer: ** The half data model has about twice the standard error for each parameter as the full data model.
