...
additional regressors will increase R2Adjp IFF the partial D statistic for testing the significant of the additional regressors exceeds 1.
...
### Model Selection
 ...
 R2Adj, Mallows, Cp, AIC, BIC all all methods of **penalized fit criteria** == a penalty is added when an extra term is added to the model to improve the fit of the model.
Eg is AIC:
