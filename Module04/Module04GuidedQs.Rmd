...
**1c What predictors would you first consider to use in a multiplie linear regression?** Briefly explain your choices.
...
**My choices are x1 and x8.** This is a balance of selected predictors and not overcomplicating the model.
...
x7's regression coefficient, .194, represents the expected change in season whens per unit change in percent rushing yards, when all the passing yards, and opponents rushing yards are held constant.

**My model estimates .194 additional season wins for each 1 percent increase in rushing yards, when controlling for the effect of the other predictors: passing yards, and opponents rushing yards.**
...
**QUESTION** Is this the conclusion???? The model estimates the season wins better than B0 = -1.808 ???
