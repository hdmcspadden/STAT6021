...
R2 Adjusted for the model is:  **0.9869**
...
This seems very strange, but it is possible that even though the two regressors are not significant when the other is held constant (as shown by the t statistics), the overall model, or joint significance of both variables as they both change values is significant (as shown by the F statistic).
